...
import com.ibrahimfouad.repository.VehicleRepository;
...
/**
 * REST controller for managing {@link com.ibrahimfouad.domain.Vehicle}.
 */
@RestController
@RequestMapping("/api")
public class VehicleResource {
     ...
     */
    @GetMapping("/vehicles")
    public ResponseEntity<List<Vehicle>> getAllVehicles(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
